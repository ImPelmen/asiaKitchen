...
<div id="tab1" class="tab-pane active">
    <div class="products-slick" data-nav="#slick-nav-1" id="childe-tab1">
        <!-- product -->
        <div v-for="product of products" :key="product.id" class="product mr-2 col-md-3 col-sm-4 col-xs-6" v-bind:class="{ active: isActive}">
            <div class="product-img" v-if="product.images[0]">
            ...
            <div class="product-body">
                <p class="product-category">{{ product.categories[0].title }}</p>
